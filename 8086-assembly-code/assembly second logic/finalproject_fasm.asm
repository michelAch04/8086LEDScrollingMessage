...
START:
   ...
   MOV SI,  LED_MATRIX           ; point SI to start of display (128)
   ADD SI, 80H
...
WRITE_WORD:
   ...
   MOV BX,  MSG_TABLE            ; pointer to currect character
   ADD BX, CX                          ; point register to current character
   
   MOV DI,  LOOKUP1              ; initialize lookup table pointer
   MOV AL, [BX]
...
SET_START:
   MOV SI,  LED_MATRIX           ; start of display (initially empty display)
